		...
		<div class="main-content">
			...
			<div class="main">
				<div class="widget" style="background-color:    #05A85C">
					<div class="title" style="background-color: #008C4D; color: #fff">Jumlah Pasien</div>
				...
				<div class="widget" style="background-color:   #F2353C">
					<div class="title" style="background-color:  #E62020;color: #fff">Jumlah Rumah Sakit</div>
				...
				<div class="widget" style="background-color:  #247CF0">
					<div class="title" style="background-color: #0B69E3; color: #fff">Jumlah Dokter</div>
				...
				<div class="widget" style="background-color: #EB2F71">
					<div class="title" style="color: #fff; background-color: #F74584">Pasien Aktif</div>
				...
				<div class="widget" style="background-color: #FAA700">
					<div class="title" style="background-color: #FCB900; color: #fff">Pasien Tidak Aktif</div>
